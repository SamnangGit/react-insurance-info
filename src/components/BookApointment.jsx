...
<form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
  ...
  <div class="flex items-center justify-between pt-10">
    <button class="bg-sky-500 text-white text-s font-bold py-1 px-60 rounded focus:outline-none focus:shadow-outline" type="button">
      Book Appointment
    </button><br>
  </div>
</form>
