  ...
  return (
    <div className="flex flex-col bg-white py-8">
      ...
      <div className="w-full flex flex-col items-center">
        <div className="my-4">
          <h1 className="font-Poppins text-3xl">1. Put Question One Here</h1>
        </div>
        <div className="font-Poppins text-xl flex flex-row">
          <button className="mx-2 my-6 rounded-full hover:bg-sky-500 focus:bg-sky-700 focus:text-white cursor-pointer border-4 focus:ring focus:ring-sky-300 focus:ring-opacity-80">
            ...
            <h2 className="mx-4 p-4 ">Put First Choice Here</h2>
          </button>
          <button className="mx-2 my-6 rounded-full hover:bg-sky-500 focus:bg-sky-700 focus:text-white cursor-pointer border-4 focus:ring focus:ring-sky-300 focus:ring-opacity-80">
            {/* <i class="fa-solid fa-circle"></i> */}
            <h2 className="mx-4 p-4 ">Put First Choice Here</h2>
      ...
      <div className="w-full flex flex-col items-center">
        <div className="my-4">
          <h1 className="font-Poppins text-3xl">2. Put Question One Here</h1>
        </div>
        <div className="font-Poppins text-xl flex flex-row">
          <button className="mx-2 my-6 rounded-full hover:bg-sky-500 focus:bg-sky-700 focus:text-white cursor-pointer border-4 focus:ring focus:ring-sky-300 focus:ring-opacity-80">
            {/* <i class="fa-solid fa-circle"></i> */}
      ...
      <div className="w-full flex flex-col items-center">
        <div className="my-4">
          <h1 className="font-Poppins text-3xl">3. Put Question One Here</h1>
        </div>
        <div className="font-Poppins text-xl flex flex-row">
          <button className="mx-2 my-6 rounded-full hover:bg-sky-500 focus:bg-sky-700 focus:text-white cursor-pointer border-4 focus:ring focus:ring-sky-300 focus:ring-opacity-80">
            {/* <i class="fa-solid fa-circle"></i> */}
      ...
      <div className="w-full flex flex-col items-center">
        <div className="my-4">
          <h1 className="font-Poppins text-3xl">4. Put Question One Here</h1>
        </div>
        <div className="font-Poppins text-xl flex flex-row">
          <button className="mx-2 my-6 rounded-full hover:bg-sky-500 focus:bg-sky-700 focus:text-white cursor-pointer border-4 focus:ring focus:ring-sky-300 focus:ring-opacity-80">
            {/* <i class="fa-solid fa-circle"></i> */}
      ...
      <div className="w-full flex flex-col items-center">
        <div className="my-4">
          <h1 className="font-Poppins text-3xl">5. Put Question One Here</h1>
        </div>
        <div className="font-Poppins text-xl flex flex-row">
          <button className="mx-2 my-6 rounded-full hover:bg-sky-500 focus:bg-sky-700 focus:text-white cursor-pointer border-4 focus:ring focus:ring-sky-300 focus:ring-opacity-80">
            {/* <i class="fa-solid fa-circle"></i> */}
